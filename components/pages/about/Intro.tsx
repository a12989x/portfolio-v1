	...
	return (
		<Box as='main' maxW='container.sm'>
			...
			<Text mb={5}>
				...
				{"'"}ll typically find me engaging with another creative or
				engaging activity such as design, gaming, curating playlists,
				solving rubik{"'"}s cube or getting lost in series!
			</Text>
			<Text>
